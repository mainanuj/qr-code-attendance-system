...
export default function AuthPage({ onAuthenticated, back }) {
  ...
  return <section className="auth-screen"><div className="auth-panel"><a className="brand auth-brand" href="#"><span className="brand-mark"><BrandLogo size={36} /></span><span>Attendly</span></a>
